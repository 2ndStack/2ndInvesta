...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var oTable = $('#datatables').dataTable({
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<c:url value='/bonus/${namaBank}/index.json' />",
            ...
            "aoColumnDefs": [
                {
                    "fnRender": function (oObj) {
                        ...
                        if (oObj.aData[3] == "PENDING") {
                            statusLink = "<a   onclick=\"return confirm(\'Apakah anda Yakin ?\')\"  class='view' href='${bonus_url}/" + oObj.aData[5] + "/COMPLETED'>Komplit</a>";
                            statusLink += "<a   onclick=\"return confirm(\'Apakah anda Yakin ?\')\" class='view' href='${bonus_url}/" + oObj.aData[5] + "/edit'>Edit</a>";

                        } else if (oObj.aData[3] == "COMPLETED") {
                            statusLink = "<a   onclick=\"return confirm(\'Apakah anda Yakin ?\')\" class='view' href='${bonus_url}/" + oObj.aData[5] + "/PENDING'>Pending</a>";
                            statusLink += "<a   onclick=\"return confirm(\'Apakah anda Yakin ?\')\" class='view' href='${bonus_url}/" + oObj.aData[5] + "/edit'>Edit</a>";
...
<div class="content">
    <div class="blocksection">
        <h2 style="text-align:center;">Daftar Bonus Bank ${namaBank}</h2>
            ...
            <tr>
               ...
               <%-- <td colspan="2">
                    <div class="buttonWrapper">
                        <a href="<c:url value='/bonus/${namaBank}/laporan'/>" class="back">Cetak Laporan </a> <br/>
                        <a href="<c:url value='/bonus/${namaBank}/laporanrek'/>" class="edit">Cetak Laporan by
                            Rekening</a>
                    </div>
                </td>--%>
            </tr>
