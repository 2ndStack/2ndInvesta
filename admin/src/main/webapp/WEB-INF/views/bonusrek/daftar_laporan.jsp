...
<div class="content">
    <div class="blocksection">
        <h2 style="text-align:center;">Daftar Laporan by Rekening Bank ${namaBank}</h2>
        <table cellpadding="0" cellspacing="0" border="0" class="display" id="datatables" width="100%">
            ...
            <c:forEach items="${data}" var="item">
                <tr>
                    <td>${no}</td>
                    <td>${item}</td>
                    <td><a href="<c:url value="/report/bonusrek/${namaBank}/${item}" />">Download</a></td>
                </tr>
            ...
            <tr>
                <td colspan="3">
                    <div class="buttonWrapper">
                        <a href="<c:url value='/bonus/${namaBank}' />" class="view">Kembali</a>
                    </div>
                </td>
            </tr>
            </tfoot>
