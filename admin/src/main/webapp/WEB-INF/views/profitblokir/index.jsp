...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var oTable = $('#datatables').dataTable({
            "bProcessing": true,
            "bServerSide": true,
            "sAjaxSource": "<c:url value='/profitblokir/${namaBank}/index.json' />",
            ...
            "aoColumnDefs": [
                {
                    "fnRender": function (oObj) {
                        ...
                        if (oObj.aData[3] == "PENDING") {
                            statusLink = "<a   onclick=\"return confirm(\'Apakah anda Yakin ?\')\" class='view' href='${profitblokir_url}/" + oObj.aData[5] + "/COMPLETED'>Komplit</a>";
                            statusLink += "<a  onclick=\"return confirm(\'Apakah anda Yakin ?\')\" class='view' href='${profitblokir_url}/" + oObj.aData[5] + "/edit'>Edit</a>";

                        } else if (oObj.aData[3] == "COMPLETED") {
                            statusLink = "<a  onclick=\"return confirm(\'Apakah anda Yakin ?\')\" class='view' href='${profitblokir_url}/" + oObj.aData[5] + "/PENDING'>Pending</a>";
                            statusLink += "<a  onclick=\"return confirm(\'Apakah anda Yakin ?\')\" class='view' href='${profitblokir_url}/" + oObj.aData[5] + "/edit'>Edit</a>";
...
<div class="content">
    <div class="blocksection">
        <h2 style="text-align:center;">Daftar profitblokir Bank ${namaBank}</h2>
            ...
            <tr>
                ...
                <td>
                    <div class="buttonWrapper">
                        <a href="<c:url value='/profitblokir/${namaBank}/masal'/>" class="back">Edit Masal</a>
                    </div>
                </td>
                <td>
                    <div class="buttonWrapper">
                        <a href="<c:url value='/profitblokir/${namaBank}/laporan'/>" class="back">Cetak By Member</a><br/>
                        <a href="<c:url value='/profitblokir/${namaBank}/laporanrek'/>" class="edit">Cetak By Rekening</a>
                    </div>
                </td>
            </tr>
            </tfoot>
