        ...
        <div class="blocksection">
            <div class="blockcontent">
                ...
                <div class="form-agree buttonWrapper">
                    <a href="<c:url value='/profitblokir/${namaBank}' />" class="back">Kembali
                    </a>
                    <a href="<c:url value='/profitblokir/${namaBank}/${data.id}/edit' />" class="edit">Ubah</a>
                </div>
            </div>
        </div>
    </form>
