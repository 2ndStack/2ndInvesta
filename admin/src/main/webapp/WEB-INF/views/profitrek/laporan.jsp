...
<div class="content">
    ...
    <c:url value="/profit/${namaBank}/laporanrek" var="profit_url"/>
    <form id="formEdit" method="post" action="${profit_url}">
        <input type="hidden" name="id" value="${profitrek.id}"/>
        ...
        <div class="blocksection">
            <div class="blockcontent">
                ...
                <dl class="form-select">
                    ...
                    <dt>
                        <label for="biayaTransfer">Biaya Transfer :</label>
                    </dt>
                    <dd>
                        <input style="text-align:right;" readonly="readonly" type="text" id="biayaTransfer" name="biayaTransfer"
                               value="${biayaTransfer}"/>
                    </dd>
                </dl>
            </div>
